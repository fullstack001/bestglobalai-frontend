    ...
    <div className="bg-gray-950 text-white font-sans">
      ...
      <div className="container py-28 mx-auto max-w-6xl relative w-full min-h-screen ">
        <section className="py-20 text-white">
          ...
          <div className="mb-8">
            <h2 className="text-3xl mb-4">Your Account</h2>
            <div className="text-lg mg-4">
              <p>
          ...
          <div className="mb-8">
            ...
            <div className="mb-4 text-lg">
              ...
              <p>
                ...
                delete or alter any proprietary rights or attribution notices in
                any content.
              </p>
              <p>
          ...
          <div className="mb-8">
            <h2 className="text-3xl mb-4">Use of Communication Services</h2>
            <div className="mb-4 text-lg">
              <p>
                ...
                group (collectively, "Communication Services").
              </p>
              <p>
                You agree to use the Communication Services only to post, send
          ...
          <div className="mb-8">
            ...
            <div className="mb-4 text-lg">
              ...
              <p>
                ...
                Conditions, the prevailing party shall be entitled to recover
                its costs and reasonable attorney's fees.
              </p>
              <p>
                The parties agree to arbitrate all disputes and claims in
                regards to these Terms and Conditions or any disputes arising as
          ...
          <div className="mb-8">
            ...
            <div className="mb-4 text-lg">
              ...
              <p>
                ...
                OTHER ONLY IN EACH'S INDIVIDUAL CAPACITY, AND NOT AS A PLAINTIFF
