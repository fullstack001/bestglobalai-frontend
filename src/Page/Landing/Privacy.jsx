    ...
    <div className="bg-gray-950 text-white font-sans">
      ...
      <div className="container py-28 mx-auto max-w-6xl relative w-full min-h-screen ">
        <section className="py-20 text-white">
          ...
          <div className="mb-8">
            ...
            <div className="text-lg">
              ...
              <p className="mt-4">
                ...
                the Company's public message boards, this information may be
              ...
              <p>
                These may include: (a) registering for an account; (b) entering
          ...
          <div className="mb-8">
            <h2 className="text-3xl mb-4">Use of your Personal Information</h2>
            <div className="text-lg">
              <p>
          ...
          <div className="mb-8">
            ...
            <div className="text-lg">
              ...
              <p>
                ...
                (email, name, address, phone number) is transferred to the third
                party.
              </p>
              <p>
                ...
                customer support, or arrange for deliveries.
              </p>
              <p>
              ...
              <p className="mt-4">
                ...
                the law or comply with legal process served on the Company or
                the site; (b) protect and defend the rights or property of the
                Company; and/or (c) act under exigent circumstances to protect
                the personal safety of users of the Company, or the public.
              </p>
            </div>
          </div>
          ...
          <div className="mb-8">
            ...
            <div className="text-lg">
              ...
              <p>
                ...
                personal information, we will refrain from disclosing your
                personal information, unless you subsequently provide express
                authorization for the disclosure of your personal information.
              </p>
              <p>
          ...
          <div className="mb-8">
            ...
            <div className="text-lg">
              <p>This website contains links to other sites.</p>
              <p>
